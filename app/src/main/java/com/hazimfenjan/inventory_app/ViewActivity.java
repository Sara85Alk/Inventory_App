        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_ONE:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_one));
                    break;
                case InventoryEntry.SUPPLIER_TOW:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_tow));
                    break;
                case InventoryEntry.SUPPLIER_THREE:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_three));
                    break;
                default:
